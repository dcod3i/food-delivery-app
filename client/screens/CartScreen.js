...
import { featured_ } from '../constants';
import { themeColors } from '../theme';
import * as Icon from "react-native-feather";
import { useNavigation } from '@react-navigation/native';

export default function CartScreen() {
  const restaurant = featured_.restaurants[0];
  ...
  return (
   <View className="bg-white flex-1">
        ...
        <View className="relative py-4 shadow-sm">
          ...
          <View>
            <Text className="text-center fot-bold text-xl"> Your cart</Text>
        ...
        className="flex-row px-4 items-center">
          <Image source={require('../assets/images/bike_21.png')} className="w-20 h-20 rounded-full" />
